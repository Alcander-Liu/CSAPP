...
; test
; ============================================================================>
; getbuf return val stores in ebx
08048dad <test>:
 8048dad:	55                   	push   %ebp
 ...
 8048db9:	89 45 f8             	mov    %eax,-0x8(%ebp)          ; local = uniqueval()
 8048dbc:	e8 9d 03 00 00       	call   804915e <getbuf>
 8048dc1:	89 c3                	mov    %eax,%ebx ; val store
 8048dc3:	e8 08 fe ff ff       	call   8048bd0 <uniqueval>
 8048dc8:	8b 55 f8             	mov    -0x8(%ebp),%edx
 8048dcb:	39 d0                	cmp    %edx,%eax
 8048dcd:	74 0e                	je     8048ddd <test+0x30>      ; if (local == uniqueval)
 8048dcf:	c7 04 24 b4 a1 04 08 	movl   $0x804a1b4,(%esp)        ; "Sabotaged!: the stack has been corrupted"
 ...
 8048de9:	c7 04 24 76 a0 04 08 	movl   $0x804a076,(%esp)        ; "Boom!: getbuf returned 0x%x\n"
 ...
 8048e03:	89 5c 24 04          	mov    %ebx,0x4(%esp)        ; val
 8048e07:	c7 04 24 93 a0 04 08 	movl   $0x804a093,(%esp)     ; "Dud: getbuf returned 0x%x\n"
